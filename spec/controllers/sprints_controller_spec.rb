  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sprint as @sprint" do
        ...
        post :create, {:sprint => { "number" => "invalid value" }}, valid_session
        assigns(:sprint).should be_a_new(Sprint)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sprint" do
        ...
        Sprint.any_instance.should_receive(:update).with({ "number" => "1" })
        put :update, {:id => sprint.to_param, :sprint => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sprint as @sprint" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sprint.any_instance.stub(:save).and_return(false)
        put :update, {:id => sprint.to_param, :sprint => { "number" => "invalid value" }}, valid_session
        assigns(:sprint).should eq(sprint)
      end
